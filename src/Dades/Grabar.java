 ...
 * @use Clase que gestiona les dades del programa: Numero de nota, canal de nota, duració de la nota, volum de la nota.
 * @use Crea i escriu un document XML mitjançant JAXP i API DOM
 */
public class Grabar
    {
    ...
    public void GrabarNota(ArrayList Nota) 
        ...
        catch (ParserConfigurationException pce) //Error al parse.
            {
            pce.printStackTrace();
            //System.out.println("Error gaurdar cançó");
            } 
        
        catch (TransformerException tfe) //Error al crear fitxer xml.
            {
            tfe.printStackTrace();
